...
@JvmName("readElement")
fun DataInput.readNbtElement(nbtTagSizeTracker: NbtTagSizeTracker = NbtTagSizeTracker.ofUnlimitedBytes()): Result<NbtElement> =
    runCatching { NbtIo.read(this, nbtTagSizeTracker) }

@JvmName("readCompound")
fun DataInput.readNbtCompound(nbtTagSizeTracker: NbtTagSizeTracker = NbtTagSizeTracker.ofUnlimitedBytes()): Result<NbtCompound> =
    runCatching { NbtIo.readCompound(this, nbtTagSizeTracker) }
