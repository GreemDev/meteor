...
object Arguments {
    ...
    @JvmOverloads fun itemPredicate(registryAccess: CommandRegistryAccess = Commands.REGISTRY_ACCESS): ItemPredicateArgumentType = ItemPredicateArgumentType.itemPredicate(registryAccess)
    @JvmOverloads fun itemStack(registryAccess: CommandRegistryAccess = Commands.REGISTRY_ACCESS): ItemStackArgumentType = ItemStackArgumentType.itemStack(registryAccess)
