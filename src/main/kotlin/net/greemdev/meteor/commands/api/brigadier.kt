...
typealias MinecraftCommandContext = CommandContext<ClientCommandSource>
typealias MinecraftLiteralBuilder = LiteralArgumentBuilder<ClientCommandSource>
typealias MinecraftArgumentBuilder<T> = RequiredArgumentBuilder<ClientCommandSource, T>
...
@BrigadierDsl
class BrigadierBuilder<T : com.mojang.brigadier.builder.ArgumentBuilder<ClientCommandSource, T>>(val builder: T) {
    val ArgType = Arguments

    infix fun requires(predicate: Predicate<ClientCommandSource>): BrigadierBuilder<T> {
