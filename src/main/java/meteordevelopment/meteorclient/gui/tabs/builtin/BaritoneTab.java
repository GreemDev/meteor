...
public class BaritoneTab extends Tab {
    ...
    public BaritoneTab() {
        super(NAME, GuiRenderer.CLEF, Config.get().baritoneIcon);
    }
    ...
    private static Settings getSettings() {
        ...
        try {
            ...
            for (Field field : klass.getDeclaredFields()) {
                ...
                if (value instanceof Boolean && !setting.getName().equalsIgnoreCase("chatControlAnyway")) {
                    sgBool.add(new BoolSetting.Builder()
                        ...
                        .description(BaritoneSettingDescriptions.get(setting))
            ...
            MeteorClient.LOG.error("Error while creating Meteor settings for Baritone!", e);
        }
