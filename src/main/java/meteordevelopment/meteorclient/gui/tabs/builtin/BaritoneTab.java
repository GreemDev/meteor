...
public class BaritoneTab extends Tab {
    ...
    private static Settings getSettings() {
        ...
        SettingGroup sgStr = settings.createGroup("Strings");
        SettingGroup sgColor = settings.createGroup("Colors");

        SettingGroup sgBlockList = settings.createGroup("Block Lists");
        SettingGroup sgItemList = settings.createGroup("Item Lists");
