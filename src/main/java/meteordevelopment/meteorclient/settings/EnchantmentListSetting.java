...
public class EnchantmentListSetting extends Setting<List<Enchantment>> {
    protected EnchantmentListSetting(String name, String description, Object defaultValue, Consumer<List<Enchantment>> onChanged, Consumer<Setting<List<Enchantment>>> onModuleActivated, IVisible visible, boolean serialize) {
