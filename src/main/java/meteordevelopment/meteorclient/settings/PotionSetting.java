...
public class PotionSetting extends EnumSetting<MyPotion> {
    protected PotionSetting(String name, String description, Object defaultValue, Consumer<MyPotion> onChanged, Consumer<Setting<MyPotion>> onModuleActivated, IVisible visible, boolean serialize) {
