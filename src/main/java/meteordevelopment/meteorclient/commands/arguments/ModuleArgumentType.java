...
public class ModuleArgumentType implements ArgumentType<@NotNull Module> {
    ...
    public ModuleArgumentType(@Nullable Predicate<Module> predicate, String moduleIsntValidForArgMessage) {
        this.predicate = Objects.requireNonNullElse(predicate, Predicates.alwaysTrue());
        this.predicateFailedMessage = Objects.requireNonNullElse(moduleIsntValidForArgMessage, "That module cannot be used for this argument.");
    }
    ...
    public static ModuleArgumentType create(Predicate<Module> predicate, String moduleIsntValidForArgMessage) {
        return new ModuleArgumentType(predicate, moduleIsntValidForArgMessage);
    }
