...
public class LocateCommand extends Command {
    ...
    private static final List<Block> netherFortressBlocks = Arrays.asList(
        Blocks.NETHER_BRICKS,
        Blocks.NETHER_BRICK_FENCE,
        Blocks.NETHER_WART
    );

    private static final List<Block> monumentBlocks = Arrays.asList(
        Blocks.PRISMARINE_BRICKS,
        Blocks.SEA_LANTERN,
        Blocks.DARK_PRISMARINE
    );

    private static final List<Block> strongholdBlocks = Collections.singletonList(
