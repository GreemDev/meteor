...
public class DropCommand extends Command {
    private static final SimpleCommandExceptionType NO_SPECTATOR = new SimpleCommandExceptionType(Text.literal("Can't drop items while in spectator."));
    ...
    private int drop(PlayerConsumer consumer) throws CommandSyntaxException {
        require(!mc.player.isSpectator(), NO_SPECTATOR);
