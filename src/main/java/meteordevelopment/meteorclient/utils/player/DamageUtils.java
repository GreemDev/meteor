...
public class DamageUtils {
    ...
    public static double getSwordDamage(PlayerEntity entity, boolean charged) {
        ...
        double damage = 0;
        if (charged) {
            if (entity.getActiveItem().isOf(Items.NETHERITE_SWORD)) {
                damage += 8;
            } else if (entity.getActiveItem().isOf(Items.DIAMOND_SWORD)) {
                damage += 7;
            } else if (entity.getActiveItem().isOf(Items.GOLDEN_SWORD)) {
                damage += 4;
            } else if (entity.getActiveItem().isOf(Items.IRON_SWORD)) {
                damage += 6;
            } else if (entity.getActiveItem().isOf(Items.STONE_SWORD)) {
                damage += 5;
            } else if (entity.getActiveItem().isOf(Items.WOODEN_SWORD)) {
                damage += 4;
            }
            damage *= 1.5;
        }
